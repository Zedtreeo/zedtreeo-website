...
export default function CandidateBrowser() {
  ...
  return (
    <>
      ...
      {/* Filter Bar — rendered inside the parent's sticky container */}
      <div className="bg-white border-b border-zt-border sticky top-[72px] z-30 -mx-6 px-6 py-4 mt-8">
      ...
      <section className="py-12 px-6 bg-zt-light-bg min-h-[60vh]">
        <div className="max-w-zt-content mx-auto">
            ...
            <p className="text-sm text-zt-body mb-0">
              ...
              {selectedCategory !== "all" && (
                <>
                  {" "}
                  in{" "}
                  <strong className="text-zt-headings">
                    {candidateCategoryLabels[selectedCategory]}
                  </strong>
                </>
              )}
            </p>
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-sm text-zt-body mb-4">
                Try adjusting your search or filters. We have 500+ professionals
          ...
          <div className="mt-16 text-center p-10 rounded-zt bg-white shadow-zt-card">
            ...
            <p
              className="text-sm text-zt-body mb-6 max-w-lg"
              style={{ marginLeft: "auto", marginRight: "auto" }}
            >
              This is a sample of our available talent. We have 500+
              professionals across 50+ role categories. Tell us what you need and
              we&apos;ll match you in 48 hours.
            </p>
    ...
    <div className="rounded-zt bg-white shadow-zt-card hover:shadow-zt-card-hover transition-all overflow-hidden">
      <div className="p-6">
        ...
        <div className="flex items-center gap-4 mb-4 text-xs text-zt-body">
          <span>
            <strong className="text-zt-headings">{candidate.experience}</strong>{" "}
            exp
          </span>
          <span>
